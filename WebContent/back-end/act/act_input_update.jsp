...
<table>
	...
	<tr>
		<td>新增活動編號:</td>
		<td><input type="TEXT" name="actNo" size="45"	placeholder="請輸入新活動項目編號"
		value="<%=actVO.getActNo()%>" /></td>
	</tr>
	<tr>
		<td>活動項目編號:<font color=red><b>*</b></font></td>
		<td><input type="TEXT" name="actEventNo" size="45"	placeholder="請輸入活動種類編號"
		value="<%=actVO.getActEventNo()%>" /></td>
	</tr>
	<tr>
		<td>活動名稱:<font color=red><b>*</b></font></td>
		<td><input type="TEXT" name="actName" size="45"	placeholder="請輸入活動項目名稱"
		value="<%=actVO.getActName()%>" /></td>
	</tr>
	<tr>
		<td>活動狀態:<font color=red><b>*</b></font></td>
		<td><input type="TEXT" name="actStatus" size="45"	placeholder="請輸入活動敘述"
